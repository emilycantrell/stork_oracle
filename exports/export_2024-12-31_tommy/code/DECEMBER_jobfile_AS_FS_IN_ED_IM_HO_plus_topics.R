...
feature_set_settings <- list(
  AS_FS_IN_ED_IM_HO_employment = c("family_age_and_sex_from_prefer_submission", 
                                "family_structure",
                                ...
                                "housing",
                                "employment"),
  AS_FS_IN_ED_IM_HO_childcare = c("family_age_and_sex_from_prefer_submission", 
                               "family_structure",
                               "income_assets_benefits",
                               "education",
                               "immigration_ethnicity",
...
results_path <- "results_AS_FS_IN_ED_IM_HO_plus_topics.csv"