...
predict_outcomes(path_to_preprocessed_holdout_data="H:/pmt/STORK_ORACLE_NO_LEAKAGE_2024-12-13/code_for_preprocessed_holdout_data_without_leakage_variable/preprocessed_holdout_data_no_leakage_2024-12-13.rds", 
                 path_to_remove_zero_variance = "H:/pmt/STORK_ORACLE_NO_LEAKAGE_2024-12-13/modeling_code_and_outputs/remove_zero_variance.RDS",
                 model_path="H:/pmt/STORK_ORACLE_NO_LEAKAGE_2024-12-13/modeling_code_and_outputs/without_leakage_pmt_train_and_evaluation_samples_seed_1_241016.csv_training_and_evaluation_set_catboost_learning_rate=NA,subsample=0.8,depth=6", 
                 path_to_results="H:/pmt/STORK_ORACLE_NO_LEAKAGE_2024-12-13/modeling_code_and_outputs/results.csv",
                 team_name="pmt_stork_oracle_", 
                 submission_name="no_leakage_predicted_probabilities_2024-12-13") 
```