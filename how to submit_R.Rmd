...
# this function predicts outcomes
predict_outcomes <- function(path_to_preprocessed_holdout_data,
                             path_to_remove_zero_variance,
                             model_path,
                             path_to_results,
                             team_name,
                             submission_name){
  ...
  # read recipe object that removes columns with zero variance in the training
  # set
  ...
  # turn probabilities into predicted classes - adjust the threshold
  # get threshold from results.csv
...
predict_outcomes(path_to_preprocessed_holdout_data=
                   "H:/pmt/stork_oracle_submission/preprocessed_holdout_intermediate.RDS",
                 path_to_remove_zero_variance =
                   "H:/pmt/stork_oracle_submission/remove_zero_variance.RDS",
                 model_path=
                   "H:/pmt/stork_oracle_submission/model.cbm",
                 path_to_results=
                   "H:/pmt/stork_oracle_submission/results.csv",
                 team_name="pmt",
                 submission_name="stork_oracle_intermediate") 
predict_outcomes(path_to_preprocessed_holdout_data=
                   "H:/pmt/stork_oracle_submission/preprocessed_holdout_final.RDS",
                 path_to_remove_zero_variance =
                   "H:/pmt/stork_oracle_submission/remove_zero_variance.RDS",
                 model_path=
                   "H:/pmt/stork_oracle_submission/model.cbm",
                 path_to_results=
                   "H:/pmt/stork_oracle_submission/results.csv",
                 team_name="pmt",
                 submission_name="stork_oracle_final")
```