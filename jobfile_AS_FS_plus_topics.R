...
feature_set_settings <- list(
  AS_FS_immigration = c("family_age_and_sex_from_prefer_submission",
                        "family_structure",
                        "immigration_ethnicity"), 
  AS_FS_income = c("family_age_and_sex_from_prefer_submission", 
                   "family_structure",
                   "income_assets_benefits"), 
  AS_FS_education = c("family_age_and_sex_from_prefer_submission", 
                      "family_structure",
                      "education"), 
  AS_FS_employment = c("family_age_and_sex_from_prefer_submission", 
                       "family_structure",
                       "employment"),
  AS_FS_housing = c("family_age_and_sex_from_prefer_submission", 
                    "family_structure",
                    "housing"), 
  AS_FS_childcare = c("family_age_and_sex_from_prefer_submission", 
                      "family_structure",
                      "childcare_proximity")
)
...
results_path <- "results_AS_FS_plus_topics.csv"