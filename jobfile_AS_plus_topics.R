...
feature_set_settings <- list(
  AS_family_structure = c("family_age_and_sex_from_prefer_submission", "family_structure"), 
  AS_immigration = c("family_age_and_sex_from_prefer_submission", "immigration_ethnicity"), 
  AS_income = c("family_age_and_sex_from_prefer_submission", "income_assets_benefits"), 
  AS_education = c("family_age_and_sex_from_prefer_submission", "education"), 
  AS_employment = c("family_age_and_sex_from_prefer_submission", "employment"),
  AS_housing = c("family_age_and_sex_from_prefer_submission", "housing"), 
  AS_childcare = c("family_age_and_sex_from_prefer_submission", "childcare_proximity")
)
...
results_path <- "results_AS_plus_topics.csv"