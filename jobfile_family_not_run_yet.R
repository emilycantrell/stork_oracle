...
feature_set_settings <- list(
  ...
  ego_partner_all_family_AS = c("ego_AS", "partner_AS", "child_age_and_sex_by_household", "family_age_and_sex_from_prefer_submission", "family_structure")
)
...
results_path <- "results_family_2025-01-20.csv"